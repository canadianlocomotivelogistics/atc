VERSION 4.00
Begin VB.Form PasswordFullVersion 
   ...
   ClientWidth     =   5490
   Height          =   8220
   Icon            =   "PasswordFullVersion.frx":0000
   Left            =   6930
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox PictureIcon 
      ...
      Height          =   480
      Left            =   120
      Picture         =   "PasswordFullVersion.frx":0442
      ScaleHeight     =   480
      ScaleWidth      =   480
      TabIndex        =   13
      Top             =   120
   ...
   Begin VB.Label Label10 
      Caption         =   $"PasswordFullVersion.frx":0884
      Height          =   855
      Left            =   120
      TabIndex        =   18
      Top             =   2220
   ...
   Begin VB.Label Label9 
      Caption         =   $"PasswordFullVersion.frx":0967
      Height          =   615
      Left            =   120
      TabIndex        =   17
      Top             =   1560
   ...
   Begin VB.Label LabelWindowDescription 
      Caption         =   $"PasswordFullVersion.frx":0A0F
      Height          =   1155
      Left            =   720
      TabIndex        =   14
      Tag             =   "0"
   ...
   End
End
Attribute VB_Name = "PasswordFullVersion"
