VERSION 4.00
Begin VB.Form MainlineOperationGuiDiesel4Screen 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Automatic Train Control - Mainline Operation GUI for SD80MAC Diesel"
   ClientHeight    =   11535
   ClientLeft      =   1245
   ClientTop       =   1050
   ClientWidth     =   15375
   ...
   Height          =   11940
   Icon            =   "MainlineOperationGuiDiesel4Screen.frx":0000
   Left            =   1185
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin TransPicture.TransPictureCtl TransPictureThrottleRight 
      ...
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":0442
   End
   Begin TransPicture.TransPictureCtl TransPictureSandRight 
      ...
      _ExtentX        =   635
      _ExtentY        =   609
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":045E
   End
   Begin TransPicture.TransPictureCtl TransPictureHeadlightRight 
      ...
      _ExtentY        =   1270
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":047A
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureHeadlight 
      ...
      _ExtentX        =   1588
      _ExtentY        =   1402
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":0496
   End
   Begin TransPicture.TransPictureCtl TransPictureThrottle 
      ...
      _ExtentY        =   1244
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":04B2
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBrakeDynamic 
      ...
      _ExtentY        =   2037
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":04CE
   End
   Begin TransPicture.TransPictureCtl TransPictureReverser 
      ...
      _ExtentX        =   3493
      _ExtentY        =   1376
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":04EA
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureSand 
      ...
      _ExtentX        =   953
      _ExtentY        =   953
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":0506
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBell 
      ...
      _ExtentX        =   820
      _ExtentY        =   609
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":0522
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBrakeIndependent 
      ...
      _ExtentX        =   3281
      _ExtentY        =   1482
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":053E
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBrakeAutomatic 
      ...
      _ExtentY        =   4498
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":055A
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureCab 
      ...
      _ExtentY        =   20320
      TransparentColor=   16777215
      MouseIcon       =   "MainlineOperationGuiDiesel4Screen.frx":0592
      Picture         =   "MainlineOperationGuiDiesel4Screen.frx":05AE
   End
   ...
   End
End
Attribute VB_Name = "MainlineOperationGuiDiesel4Screen"
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    For TemporaryCounter = 9 To 0 Step -1
        ...
        If TemporaryScreen <> "Unused" Then
            If TemporaryScreen = "Mainline Operation GUI Diesel4 Screen" Then
            ...
            ElseIf MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Button Close, current window is not listed in the stack to remove it and hide."
            End If
    ...
    ' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            ElseIf MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Button Close, trying to display the previous window using the screen stack, window not recognized."
            End If
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
' End Loop Premature
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    If TemporaryCounter = -1 Then
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Button Close, stack is empty, underflow."
        End If
    End If
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
' End Subroutine
...
Private Sub Form_Activate()
    ...
    If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then 'Darrin
        Let DebugMode!TextBoxDebugMode.Text = DebugMode!TextBoxDebugMode.Text & "Beginning,  Mainline Operation GUI Diesel4 Screen, Form, Activate" & vbCrLf
    End If ' Debug Tag
...
' =============================================================================================================================================================================
    ...
    For TemporaryCounter = 0 To 9
        ...
        ' ---------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Let Ini.Value = "Mainline Operation GUI Diesel4 Screen"
            Let TemporaryCounter = 11
        End If
    ' -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
' ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    If TemporaryCounter = 10 Then
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Form Activate, stack is full, overflow."
        End If
    End If
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    If TemporaryBackgroundImage = "On" Then
        ...
        Else
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Form Activate, variable error in ATC.INI file for 'Transparency' setting."
            End If
        End If
    ...
    Else
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Form Activate, variable error in ATC.INI file for 'Background' setting."
        End If
    End If
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then 'Darrin
        Let DebugMode!TextBoxDebugMode.Text = DebugMode!TextBoxDebugMode.Text & "Ending, Mainline Operation GUI Diesel4 Screen, Form, Activate" & vbCrLf
    End If ' Debug Tag
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Let Ini.Filename = App.Path$ & "\Atc.ini"
    Let Ini.Application = "Mainline Operation GUI Diesel4 Screen"
    Let Ini.Parameter = "Top"
    Let Ini.Value = Str$(MainlineOperationGuiDiesel4Screen.Top)
    Let Ini.Parameter = "Left"
    Let Ini.Value = Str$(MainlineOperationGuiDiesel4Screen.Left)
    Let Ini.Parameter = "Width"
    Let Ini.Value = Str(MainlineOperationGuiDiesel4Screen.Width)
    Let Ini.Parameter = "Height"
    Let Ini.Value = Str(MainlineOperationGuiDiesel4Screen.Height)
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    If TemporaryBackgroundImage = "On" Then
        ...
        Else
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Form Deactivate, variable error in ATC.INI file for 'Tranparency' setting."
            End If
        End If
    ElseIf TemporaryBackgroundImage = "Off" Then
        AlphaBlend.Enabled = False
    Else
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Form Deactivate, variable error in ATC.INI file for 'Background' setting."
        End If
    End If
...
' Hide Screen
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    MainlineOperationGuiDiesel4Screen.Hide
    Unload MainlineOperationGuiDiesel4Screen
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Let TemporaryLocomotivePath$ = "\Graphics\Locomotive Diesel4\"

    TransPictureCab.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "CabScreen(d4).bmp")
    TransPictureHorn.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "Horn0(d4).bmp")
    TransPictureBrakeAutomatic.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "BrakeAutomatic0(d4).bmp")
    TransPictureBrakeIndependent.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "BrakeIndependent0(d4).bmp")
    TransPictureSand.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "Sand0(d4).bmp")
    TransPictureBell.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "Bell0(d4).bmp")
    TransPictureThrottle.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "Throttle0(d4).bmp")
    TransPictureBrakeDynamic.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "BrakeDynamic0(d4).bmp")
    TransPictureReverser.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "Reverser1(d4).bmp")
    TransPictureHeadlight.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "Headlight0(d4).bmp")
    PictureSpeedometer.Picture = LoadPicture(App.Path$ & TemporaryLocomotivePath$ & "Speedometer(d4).bmp")
...
Private Sub Form_Resize()
    ...
    If MainlineOperationGuiDiesel4Screen.WindowState = vbMinimized Then
        ...
        ElseIf MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Resize, variable not set correctly for 'BackGround Image' in ATC.INI file."
        End If

    ElseIf MainlineOperationGuiDiesel4Screen.WindowState = vbNormal Then
...
Let Temporary$ = Temporary$ + "\Graphics\Locomotive Diesel4\AutomaticBrake"
...
Let Temporary$ = App.Path$
Let Temporary$ = Temporary$ + "\Graphics\Locomotive Diesel4\Bell"
...
Let Temporary$ = App.Path$
Let Temporary$ = Temporary$ + "\Graphics\Locomotive Diesel4\DynamicBrake"
...
Public Sub TransPictureBell_Click()
    ...
    Let MainlineOperationGuiDiesel4Screen.MousePointer = ccHourglass
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Box Bell, unable to setup balloon help for 'TransPictureBell' control."
            End If
        End If

    End If
    
    Let MainlineOperationGuiDiesel4Screen.MousePointer = ccDefault
...
UpdateBell:
    ...
    Let TransPictureBell.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\Bell" & TransPictureBell.Tag & "(d3).bmp")
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Box Automatic Brake, unable to setup balloon help for 'transpicturebrakeautomatic' control."
            End If
        End If
...
UpdateBrakeAutomatic:
    ...
    Let temp = App.Path$ & "\Graphics\Locomotive Diesel4\BrakeAutomatic" & Trim$(TransPictureBrakeAutomatic.Tag) & "(d3).bmp"
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Box Dynamic Brake, unable to setup balloon help for 'TransPictureBrakeDynamic' control."
            End If
        End If
...
UpdateBrakeDynamic:
    ...
    Let TransPictureBrakeDynamic.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\BrakeDynamic" & Trim$(TransPictureBrakeDynamic.Tag) & "(d3).bmp")
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Box Independent Brake, unable to setup balloon help for 'TransPictureBrakeIndependent' control."
            End If
        End If
...
UpdateBrakeIndependent:
    ...
    Let temp = App.Path$ & "\Graphics\Locomotive Diesel4\BrakeIndependent" & Trim$(TransPictureBrakeIndependent.Tag) & "(d3).bmp"
...
UpdateHeadlight:
    ...
    Let TransPictureHeadlight.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\HeadLight" & Trim$(TransPictureHeadlight.Tag) & "(d3).bmp")
    Let TransPictureHeadlightRight.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\HeadlightRight" & Trim$(TransPictureHeadlight.Tag) & "(d3).bmp")
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Box Horn, unable to setup balloon help for 'TransPictureHorn' control."
            End If
        End If
...
UpdateHorn:
    ...
    If TransPictureHorn.Tag = "0" Then
        ...
        Let temp = App.Path
        Let temp = temp + "\Graphics\Locomotive Diesel4\Horn1(d3).bmp"
    ...
    Else
        ...
        Let temp = App.Path
        Let temp = temp + "\Graphics\Locomotive Diesel4\Horn0(d3).bmp"
        Let TransPictureHorn.Picture = LoadPicture(temp)
...
Let Temporary$ = App.Path$
Let Temporary$ = Temporary$ + "\Graphics\Locomotive Diesel4\LocomotiveBrake"
...
Let Temporary$ = App.Path$
Let Temporary$ = Temporary$ + "\Graphics\Locomotive Diesel4\Reverser"
...
Let Temporary$ = App.Path$
Let Temporary$ = Temporary$ + "\Graphics\Locomotive Diesel4\Sand"
...
'    Let PictureBoxVirtualCabSignalCurrent(0).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\SignalLightGreen(d3).bmp")
'    Let PictureBoxVirtualCabSignalCurrent(1).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\SignalLightRed(d3).bmp")
'    Let PictureBoxVirtualCabSignalCurrent(2).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\SignalLightRed(d3).bmp")'
'
'    Let TextBoxVirtualCabSignalStatusApproaching = "Clear"
'    Let PictureBoxVirtualCabSignalApproaching(0).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\SignalLightGreen(d3).bmp")
'    Let PictureBoxVirtualCabSignalApproaching(1).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\SignalLightRed(d3).bmp")
'    Let PictureBoxVirtualCabSignalApproaching(2).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\SignalLightRed(d3).bmp")
'    Stop
'Else
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            If BalloonHelpSetup = 0 Then
                If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                    ...
                    Let Ini.Application = "Log Errors"
                    Let Ini.Parameter = Date$ & " " & Time$
                    Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Reverser, unable to setup balloon help for 'PictureReverser' control."
                End If
            End If
        End If
...
UpdateReverser:
    ...
    Let TransPictureReverser.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\Reverser" & Trim$(TransPictureReverser.Tag) & "(d3).bmp")
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Trans Picture Sand, unable to setup balloon help for 'TransPictureSand' control."
            End If
        End If
...
UpdateSand:
    ...
    Let TransPictureSand.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\Sand" & TransPictureSand.Tag & "(d3).bmp")
    Let TransPictureSandRight.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\SandRight" & TransPictureSand.Tag & "(d3).bmp")
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Box Throttle, unable to setup balloon help for 'TransPictureThrottle' control."
            End If
        End If
        ...
        If BalloonHelpSetup = 0 Then
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Operation GUI Diesel4 Screen, Picture Box Throttle Right, unable to setup balloon help for 'TransPictureThrottle' control."
            End If
        End If
...
UpdateThrottle:
    ...
    Let TransPictureThrottle.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\Throttle" & Trim$(TransPictureThrottle.Tag) & "(d3).bmp")
    Let TransPictureThrottleRight.Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive Diesel4\ThrottleRight" & Trim$(TransPictureThrottle.Tag) & "(d3).bmp")
