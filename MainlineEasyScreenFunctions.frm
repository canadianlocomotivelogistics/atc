VERSION 4.00
Begin VB.Form MainlineEasyScreenFunctions 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Automatic Train Control - Mainline Mode - Easy Screen Functions"
   ClientHeight    =   7950
   ClientLeft      =   4680
   ClientTop       =   4005
   ClientWidth     =   8985
   Height          =   8355
   Icon            =   "MainlineEasyScreenFunctions.frx":0000
   Left            =   4620
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   7950
   ...
   Begin VB.Label LabelFunction8 
      Caption         =   "Function eight controls no ouputs."
      Height          =   255
      Left            =   240
      TabIndex        =   123
      Top             =   7560
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   120
      Picture         =   "MainlineEasyScreenFunctions.frx":0442
      Top             =   240
      Width           =   480
   End
   Begin VB.Label Label1 
      Caption         =   $"MainlineEasyScreenFunctions.frx":0884
      Height          =   495
      Left            =   840
      TabIndex        =   0
      Top             =   240
   ...
   End
End
Attribute VB_Name = "MainlineEasyScreenFunctions"
Attribute VB_Creatable = False
Attribute VB_Exposed = False
Private Sub ButtonClose_Click()

Let MainlineDecoder!LocomotiveDecoderCVd(33) = textboxcvvalue(33).Text
Let MainlineDecoder!LocomotiveDecoderCVd(34) = textboxcvvalue(34).Text
Let MainlineDecoder!LocomotiveDecoderCVd(35) = textboxcvvalue(35).Text
Let MainlineDecoder!LocomotiveDecoderCVd(36) = textboxcvvalue(36).Text
Let MainlineDecoder!LocomotiveDecoderCVd(37) = textboxcvvalue(37).Text
Let MainlineDecoder!LocomotiveDecoderCVd(38) = textboxcvvalue(38).Text
Let MainlineDecoder!LocomotiveDecoderCVd(39) = textboxcvvalue(39).Text
Let MainlineDecoder!LocomotiveDecoderCVd(40) = textboxcvvalue(40).Text
Let MainlineDecoder!LocomotiveDecoderCVd(41) = textboxcvvalue(41).Text
Let MainlineDecoder!LocomotiveDecoderCVd(42) = textboxcvvalue(42).Text
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    For TemporaryCounter = 9 To 0 Step -1
        ...
        If TemporaryScreen <> "Unused" Then
            If TemporaryScreen = "Mainline Easy Screen Functions Screen" Then
            ...
            ElseIf MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Value = "Mainline Easy Screen Functions Screen, Button Close, current window is not listed in the stack to remove it and hide."
            End If
    ...
    ' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            ElseIf MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Easy Screen Functions Screen, Button Close, trying to display the previous window using the screen stack, window not recognized."
            End If
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
' End Loop Premature
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    If TemporaryCounter = -1 Then
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Easy Screen Functions Screen, Button Close, stack is empty, underflow."
        End If
    End If
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
' End Subroutine
...
Private Sub ButtonPrint_Click()
    ...
    MainlineEasyScreenFunctions.PrintForm
...
' =============================================================================================================================================================================
    ...
    For TemporaryCounter = 0 To 9
        ...
        ' ---------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Let Ini.Value = "Mainline Easy Screen Functions Screen"
            Let TemporaryCounter = 11
        End If
    ' -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
' ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    If TemporaryCounter = 10 Then
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Easy Screen Functions Screen, Form Activate, stack is full, overflow."
        End If
    End If
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    If TemporaryBackgroundImage = "On" Then
        ...
        Else
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Easy Screen Functions Screen, Form Activate, variable error in ATC.INI file for 'Transparency' setting."
            End If
        End If
    ...
    Else
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Easy Screen Functions Screen, Form Activate, variable error in ATC.INI file for 'Background' setting."
        End If
    End If
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Let Ini.Filename = App.Path$ & "\Atc.ini"
    Let Ini.Application = "Mainline Easy Screen Functions Screen"
    Let Ini.Parameter = "Top"
    Let Ini.Value = Str$(MainlineEasyScreenFunctions.Top)
    Let Ini.Parameter = "Left"
    Let Ini.Value = Str$(MainlineEasyScreenFunctions.Left)
    Let Ini.Parameter = "Width"
    Let Ini.Value = Str(MainlineEasyScreenFunctions.Width)
    Let Ini.Parameter = "Height"
    Let Ini.Value = Str(MainlineEasyScreenFunctions.Height)
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    If TemporaryBackgroundImage = "On" Then
        ...
        Else
            If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
                ...
                Let Ini.Application = "Log Errors"
                Let Ini.Parameter = Date$ & " " & Time$
                Let Ini.Value = "Mainline Easy Screen Functions Screen, Form Deactivate, variable error in ATC.INI file for 'Tranparency' setting."
            End If
        End If
    ElseIf TemporaryBackgroundImage = "Off" Then
        AlphaBlend.Enabled = False
    Else
        If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
            ...
            Let Ini.Application = "Log Errors"
            Let Ini.Parameter = Date$ & " " & Time$
            Let Ini.Value = "Mainline Easy Screen Functions Screen, Form Deactivate, variable error in ATC.INI file for 'Background' setting."
        End If
    End If
...
' Hide Screen
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    MainlineEasyScreenFunctions.Hide
    'unload Mainlineeasyscreenfunctions
...
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    If Val(TemporaryValueLeft) = 0 And Val(TemporaryValueTop) = 0 Then
        MainlineEasyScreenFunctions.Left = (Screen.Width - Width) / 2
        MainlineEasyScreenFunctions.Top = (Screen.Height - Height) / 2
    Else
        If Val(TemporaryValueLeft) + MainlineEasyScreenFunctions.Width > Screen.Width Then
            Let MainlineEasyScreenFunctions.Left = Screen.Width - MainlineEasyScreenFunctions.Width
        Else
            Let MainlineEasyScreenFunctions.Left = Val(TemporaryValueLeft)
        End If
        If Val(TemporaryValueTop) + MainlineEasyScreenFunctions.Height > Screen.Height Then
            Let MainlineEasyScreenFunctions.Top = Screen.Height - MainlineEasyScreenFunctions.Height
        Else
            Let MainlineEasyScreenFunctions.Top = Val(TemporaryValueTop)
        End If
    End If
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Private Sub UpdateLabelFunctionLF()
    ...
    For j = 1 To 8
        If CheckBoxCV33(j).Value = vbChecked Then
            Let LabelFunctionLF.Caption = "Function zero (white wire) controls the follwoing outputs, "
...
Private Sub UpdateLabelFunctionLR()
    ...
    For j = 1 To 8
        If CheckBoxCV34(j).Value = vbChecked Then
            Let LabelFunctionLR.Caption = "Function zero (yellow wire) controls the following outputs, "
            Let Temporary$ = Temporary$ + Str$(j - 1) + " "
        End If
    Next j
...
For j = 1 To 8
    If CheckBoxCV38(j).Value = vbChecked Then
        Let LabelFunction4.Caption = "Function four controls the follwoing outputs, "
        Let Temporary$ = Temporary$ + Str$(j + 1) + " "
    End If
Next j
...
Let Temporary$ = ""
Let LabelFunction7.Caption = "Function seven control no outputs."
For j = 1 To 8
...
Private Sub BalloonHelpPart1()
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "thrity-three, outputs for function zero. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "thrity-four, outputs for function zero. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "thrity-five, outputs for function one. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "thrity-six, outputs for function two. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "thrity-seven, outputs for function three. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "thrity-eight, outputs for function four. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "thrity-nine, outputs for function five. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "fourty, outputs for function six. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "fourty-one, outputs for function seven. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
     ...
     Let TemporaryText1 = "This text box displays the value for configuration variable" & vbCrLf & "fourty-two, outputs for function eight. When  you 'Close'" & vbCrLf & "this screen the value of the configuration value will copied" & vbCrLf & "to the 'Mainline Programming Decoder' screen."
...
Private Sub BalloonHelpPart2()
     ...
     Let TemporaryText1 = "This button closes this screen and returns you to" & vbCrLf & "the 'Mainline Mode - Decoder' screen."
     Let TemporaryText2 = "Output Fourteen for Function Eight"
...
Private Sub Form_Resize()
    ...
    If MainlineEasyScreenFunctions.WindowState = vbMinimized Then
    ...
    ElseIf MainlineEasyScreenFunctions.WindowState = vbNormal Then
