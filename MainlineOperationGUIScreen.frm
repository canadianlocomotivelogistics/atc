VERSION 4.00
Begin VB.Form MainlineOperationGuiDieselScreen 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   BorderStyle     =   0  'None
   ClientHeight    =   11295
   ...
   Begin VB.PictureBox PictureBoxLocomotiveCab 
      ...
      Begin VB.TextBox LabelCaption 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   150
         Text            =   "MainlineOperationGUIScreen.frx":0000
         Top             =   5400
         Visible         =   0   'False
         Width           =   2175
      End
      ...
      Begin VB.PictureBox PictureBoxComputerScreenLeft 
         ...
         Begin VB.PictureBox PictureBoxSpeedometer 
            ...
            Height          =   2460
            Left            =   0
            Picture         =   "MainlineOperationGUIScreen.frx":0006
            ScaleHeight     =   2460
            ScaleWidth      =   2220
            TabIndex        =   120
            Top             =   0
   ...
   End
End
Attribute VB_Name = "MainlineOperationGuiDieselScreen"
    ...
    If MainlineOperationGUI.CheckBoxSoundDecoderEquipped = vbChecked Then
        If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) >= 0 And _
           Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) < 7 Then
            ...
            Else
                If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "2" Then
                    Let MainlineOperationGUI!ConsistControlFunction2.Value = vbChecked
                Else
                    If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "3" Then
                        Let MainlineOperationGUI!ConsistControlFunction3.Value = vbChecked
                    Else
                        If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "4" Then
                            Let MainlineOperationGUI!ConsistControlFunction4.Value = vbChecked
                        Else
                            If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "5" Then
                                Let MainlineOperationGUI!ConsistControlFunction5.Value = vbChecked
                            Else
                                If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "6" Then
                                    Let MainlineOperationGUI!ConsistControlFunction6.Value = vbChecked
                                Else
                                    If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "7" Then
                                        Let MainlineOperationGUI!ConsistControlFunction7.Value = vbChecked
                                    Else
                                        If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "8" Then
                                            Let MainlineOperationGUI!ConsistControlFunction8.Value = vbChecked
                                        'Else
                                        '   If MainlineOperationGUI!TextBoxMappedFunctionRPMMinus.Text = "9" Then
        ...
        If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) = 0 Then
            If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "1" Then
                Let MainlineOperationGUI!ConsistControlFunction1.Value = vbUnchecked
            Else
                If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "2" Then
                    Let MainlineOperationGUI!ConsistControlFunction2.Value = vbUnchecked
                Else
                    If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "3" Then
                        Let MainlineOperationGUI!ConsistControlFunction3.Value = vbUnchecked
                    Else
                        If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "4" Then
                            Let MainlineOperationGUI!ConsistControlFunction4.Value = vbUnchecked
                        Else
                            If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "5" Then
                                Let MainlineOperationGUI!ConsistControlFunction5.Value = vbUnchecked
                            Else
                                If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "6" Then
                                    Let MainlineOperationGUI!ConsistControlFunction6.Value = vbUnchecked
                                Else
                                    If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "7" Then
                                        Let MainlineOperationGUI!ConsistControlFunction7.Value = vbUnchecked
                                    Else
                                        If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "8" Then
                                            Let MainlineOperationGUI!ConsistControlFunction8.Value = vbUnchecked
                                        'Else
                                        '   If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "9" Then
                                        '        Let MainlineOperationGUI!ConsistControlFunction9.Value = vbunChecked
                                        '    End If
                                        End If
                                    End If
...
Let PictureBoxRadioPhone.Picture = LoadPicture(App.Path + "\Gui\PhoneOnHook.bmp")
...
If Button = vbRightButton Then
    ...
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalApproaching(0).Picture = LoadPicture(App.Path$ & "/Gui/SignalLightGreen.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalApproaching(1).Picture = LoadPicture(App.Path$ & "/Gui/SignalLightRed.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalApproaching(2).Picture = LoadPicture(App.Path$ & "/Gui/SignalLightRed.bmp")
    Let MainlineOperationGuiDieselScreen!textboxvirtualCabsignalstatuscurrent.Text = "Clear"
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalCurrent(0).Picture = LoadPicture(App.Path$ & "/Gui/SignalLightGreen.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalCurrent(1).Picture = LoadPicture(App.Path$ & "/Gui/SignalLightRed.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalCurrent(2).Picture = LoadPicture(App.Path$ & "/Gui/SignalLightRed.bmp")
End If
...
If Button = vbRightButton Then
    ...
    Else
        ...
        Let PictureBoxRadioPhone.Picture = LoadPicture(App.Path + "\Gui\PhoneOffHook.bmp")
    End If
End If
...
Let temp = App.Path$ & "/Gui/ResetRightOn.bmp"
...
If Val(TextBoxStatusThrottle.Text) < 0 Then
    Let temp = App.Path$ & "\Gui\DynamicBrake"
Else
    Let temp = App.Path$ & "\Gui\Throttle"
End If
...
Private Sub PictureBoxResetRight_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Let Temporary$ = App.Path$ & "/Gui/ResetRightOff.bmp"
