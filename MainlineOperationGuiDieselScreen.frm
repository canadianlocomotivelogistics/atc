...
Begin VB.Form MainlineOperationGuiDiesel1Screen 
   ...
   Begin VB.PictureBox PictureBoxLocomotiveCab 
      ...
      Begin VB.TextBox LabelCaption 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   150
         Text            =   "MainlineOperationGuiDieselScreen.frx":0000
         Top             =   5400
         Visible         =   0   'False
         Width           =   2175
      End
      ...
      Begin VB.PictureBox PictureBoxComputerScreenLeft 
         ...
         Begin VB.PictureBox PictureBoxSpeedometer 
            ...
            Height          =   2460
            Left            =   0
            Picture         =   "MainlineOperationGuiDieselScreen.frx":0006
            ScaleHeight     =   2460
            ScaleWidth      =   2220
            TabIndex        =   120
            Top             =   0
      ...
      Begin VB.PictureBox PictureBoxBell 
         ...
         Width           =   765
      End
      Begin VB.TextBox TextBoxStatusRadioPhone 
         Appearance      =   0  'Flat
         BorderStyle     =   0  'None
         Enabled         =   0   'False
         Height          =   195
         ...
         Width           =   375
      End
      Begin VB.PictureBox PictureBoxRadioPhone 
         Appearance      =   0  'Flat
         BackColor       =   &H80000005&
         BorderStyle     =   0  'None
         ForeColor       =   &H80000008&
      ...
      Begin VB.Label Label38 
         ...
         Width           =   2070
      End
      Begin VB.Label LabelStatusRadioPhone 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         BackStyle       =   0  'Transparent
         Caption         =   "TextBoxStatusRadioPhone"
         ForeColor       =   &H80000008&
         Height          =   195
         Left            =   1440
         TabIndex        =   153
...
'
    ...
    Let MainlineOperationGuiDieselScreen!TextBoxStatusSpeedStep = 0
    Let MainlineOperationGuiDieselScreen!TextBoxStatusSpeedStepNow = 0
    Let MainlineOperationGuiDieselScreen!TextBoxStatusSpeedStepModified = 0
            
    ' ---------------------------------------------------------------------------------------------------------------------
    ' Move Throttle to Zero
    
ONEMORE:
    If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) > 0 Then
        Let MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text = Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) - 1
    End If
    ...
    If MainlineOperationGUI.CheckBoxSoundDecoderEquipped = vbChecked Then
        If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) >= 0 And _
           Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) < 7 Then
           
            If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "1" Then
            ...
            ElseIf MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "8" Then
                Let MainlineOperationGUI!ConsistControlFunction8.Value = vbnChecked
            ElseIf MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "9" Then
                Let MainlineOperationGUI!ConsistControlFunction9.Value = vbnChecked
            ElseIf MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "10" Then
                Let MainlineOperationGUI!ConsistControlFunction10.Value = vbnChecked
            ElseIf MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "11" Then
                Let MainlineOperationGUI!ConsistControlFunction11.Value = vbnChecked
            ElseIf MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "12" Then
                Let MainlineOperationGUI!ConsistControlFunction12.Value = vbnChecked
            End If
        ...
        If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) = 0 Then
            If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "1" Then
                Let MainlineOperationGUI!ConsistControlFunction1.Value = vbUnchecked
        ...
        If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) < -1 Then
            If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "1" Then
                Let MainlineOperationGUI!ConsistControlFunction1.Value = vbChecked
            ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "2" Then
                Let MainlineOperationGUI!ConsistControlFunction2.Value = vbChecked
    ...
    Let temp = App.Path
    If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) < 0 Then
        Let temp = temp + "\Graphics\Locomotive\9-40CW\DynamicBrake"
    Else
        Let temp = temp + "\Graphics\Locomotive 9-40CW\Throttle"
    End If
    Let temp = temp + Right$(Str$(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text), 1)
    Let temp = temp + ".bmp"

    Let MainlineOperationGuiDieselScreen!PictureBoxThrottle.Picture = LoadPicture(temp)
    For t = 1 To 1000
        DoEvents
    Next t
            
    If Val(MainlineOperationGuiDieselScreen!TextBoxStatusThrottle.Text) <> 0 Then GoTo ONEMORE

'
' End of Throttle Routine
' -------------------------------------------------------------------------------------------------------------------------
...
MainlineOperationGuiDieselScreen.Hide
Unload MainlineOperationGuiDieselScreen
...
If ButtonDetail.Caption = "&Data is On" Then
    ...
    Let ButtonDetail.Caption = "&Data is Off"
    ...
    Let LabelStatusRadioPhone.Visible = False
    ...
    Let Label2.Visible = False
    Let Label3.Visible = False
    Let Label4.Visible = False
    
    Let TextBoxStatusIndependentBrakePressure.Visible = False
    Let TextBoxStatusAutomaticBrakePressure.Visible = False
    Let TextBoxStatusDynamicBrakeApplication.Visible = False
    ...
    Let TextBoxStatusRadioPhone.Visible = False
    ...
    Let TextBoxVirtualCabSignalDistance.Visible = False
    Let TextBoxVirtualCabSignalStatusApproaching.Visible = False
    Let textboxvirtualCabsignalstatuscurrent.Visible = False
    Let TextBoxSettingDeadmannInterval.Visible = False
    Let TextboxSettingIndependentAirBrake.Visible = False
    Let TextboxSettingAutomaticAirBrake.Visible = False
    Let TextBoxSettingsendcommandInterval.Visible = False
    Let TextBoxSettingSpeedChangeInterval.Visible = False
...
Else
    ...
    Let LabelStatusRadioPhone.Visible = True
    ...
    Let TextBoxStatusRadioPhone.Visible = True
    ...
    Let TextBoxVirtualCabSignalDistance.Visible = True
    Let TextBoxVirtualCabSignalStatusApproaching.Visible = True
    Let textboxvirtualCabsignalstatuscurrent.Visible = True
    Let TextBoxSettingDeadmannInterval.Visible = True
    Let TextboxSettingIndependentAirBrake.Visible = True
    Let TextboxSettingAutomaticAirBrake.Visible = True
    Let TextBoxSettingsendcommandInterval.Visible = True
    Let TextBoxSettingSpeedChangeInterval.Visible = True
End If
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        Let MainlineOperationGUI!timerlabel.Interval = 1000 * Val(MainlineOperationGUI!TextBoxTonnage.Text)
        Let MainlineOperationGUI!timerlabel.Enabled = True
        Let LabelCaption.Text = "Fuel Refilling Button"
        
        Let LabelCaption.Height = 19.43
        Let LabelCaption.Width = 145.284
...
MainlineOperationGuiDieselScreen.PopupMenu menuCaptureDevice
...
'    Top = (Screen.Height - Height) / 2  ' Center form verti'Call y.

Let PictureBoxLocomotiveCab.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\CabScreen.bmp")
Let PictureBoxResetLeft.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\ResetLeftOff.bmp")
Let PictureBoxSand.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\SandOff.bmp")
Let PictureBoxBell.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\BellOff.bmp")
Let PictureBoxHorn.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\HornOff.bmp")
Let PictureBoxReverser.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\reverser1.bmp")
Let PictureBoxThrottle.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\Throttle0.bmp")
Let PictureBoxAutomaticBrake.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\AutomaticBrake 0.bmp")
Let PictureBoxIndependentBrake.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\IndependentBrake9.bmp")
Let PictureBoxResetRight.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\ResetRightOff.bmp")
Let PictureBoxLight.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\Light0.bmp")
Let PictureBoxRadioPhone.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\PhoneOnHook.bmp")
...
Let temp = App.Path$
Let temp = temp + "\Graphics\Locomotive 9-40CW\AutomaticBrake"
Let temp = temp + Right$(Str$(TextBoxStatusAutomaticBrake.Text), 2)
Let temp = temp + ".bmp"

Let PictureBoxAutomaticBrake.Picture = LoadPicture(temp)

If TextBoxStatusThrottle.Text <> 0 And TextBoxStatusReverser.Text <> 1 Then
    Let MainlineOperationGUI!timerdeadmann.Enabled = False
    Let MainlineOperationGUI!timerdeadmann.Interval = MainlineOperationGuiDieselScreen!TextBoxSettingDeadmannInterval.Text
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Text = "Automatic Brakes" & Chr$(13) & Chr$(10)
    
        Let LabelCaption.Text = LabelCaption.Text & "at " & Str$(Int(Val(100 - (TextBoxStatusAutomaticBrakePressure.Text) * 100))) & " percent"

        Let LabelCaption.Height = 33.747
        Let LabelCaption.Width = 145.284
...
If TextBoxStatusBell.Text = "Off" Then
    ...
    Let temp = App.Path$
    Let temp = temp + "\Graphics\Locomotive 9-40CW\BellOn.bmp"
...
Else
    ...
    Let temp = App.Path$
    Let temp = temp + "\Graphics\Locomotive 9-40CW\BellOff.bmp"
    Let PictureBoxBell.Picture = LoadPicture(temp)
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Text = "Bell Switch" & Chr$(13) & Chr$(10)
    
        If TextBoxStatusBell.Text = "Off" Then
            Let LabelCaption.Text = LabelCaption.Text & "is Not Active"
        ElseIf TextBoxStatusBell.Text = "On" Then
            Let LabelCaption.Text = LabelCaption.Text & "is Active"
        End If
...
If TextBoxStatusHorn.Text = "Off" Then
    ...
    Let temp = App.Path
    Let temp = temp + "\Graphics\Locomotive 9-40CW\HornOn.bmp"
...
Else
    ...
    Let temp = App.Path
    Let temp = temp + "\Graphics\Locomotive 9-40CW\HornOff.bmp"
    Let PictureBoxHorn.Picture = LoadPicture(temp)
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Text = "Horn Switch" & Chr$(13) & Chr$(10)
    
        If TextBoxStatusHorn.Text = "Off" Then
            Let LabelCaption.Text = LabelCaption.Text & "is Not Active"
        ElseIf TextBoxStatusHorn.Text = "On" Then
            Let LabelCaption.Text = LabelCaption.Text & "is Active"
        End If
...
Let temp = App.Path$
Let temp = temp + "\Graphics\Locomotive 9-40CW\IndependentBrake"
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        Let MainlineOperationGUI!timerlabel.Interval = 1000 * Val(MainlineOperationGUI!TextBoxTonnage.Text)
        Let MainlineOperationGUI!timerlabel.Enabled = True
        Let LabelCaption.Text = "Independent Brakes" & Chr$(13) & Chr$(10)
        
        Let LabelCaption.Text = LabelCaption.Text & "at " & Str$(Int(100 - (Val(TextBoxStatusIndependentBrakePressure.Text) * 100))) & " percent"
...
Let temp = App.Path
Let temp = temp + "\Graphics\Locomotive 9-40CW\Light"
...
If TextBoxStatusLight.Text = "0" Then
    ...
    ElseIf MainlineOperationGUI!TextBoxLocomotiveDecoderDim.Text = "12" Then
        Let MainlineOperationGUI!ConsistControlFunction12.Value = vbUnchecked
    End If
ElseIf TextBoxStatusLight.Text = "1" Then
...
ElseIf TextBoxStatusLight.Text = "2" Then
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        Let MainlineOperationGUI!timerlabel.Interval = 1000 * Val(MainlineOperationGUI!TextBoxTonnage.Text)
        Let MainlineOperationGUI!timerlabel.Enabled = True
        Let LabelCaption.Text = "Light Switch" & Chr$(13) & Chr$(10)
        
        If TextBoxStatusLight.Text = 0 Then
            Let LabelCaption.Text = LabelCaption.Text & "is currently off"
        ElseIf TextBoxStatusLight.Text = 1 Then
            Let LabelCaption.Text = LabelCaption.Text & "is on and dimmed"
        ElseIf TextBoxStatusLight.Text = 2 Then
            Let LabelCaption.Text = LabelCaption.Text & "is on"
        End If
...
Private Sub PictureBoxRadioPhone_KeyDown(KeyCode As Integer, Shift As Integer)

If KeyCode = Asc("W") Then Let PictureBoxRadioPhone.Top = Val(PictureBoxRadioPhone.Top) - 1
If KeyCode = Asc("A") Then Let PictureBoxRadioPhone.Left = Val(PictureBoxRadioPhone.Left) - 1
If KeyCode = Asc("S") Then Let PictureBoxRadioPhone.Left = Val(PictureBoxRadioPhone.Left) + 1
If KeyCode = Asc("Z") Then Let PictureBoxRadioPhone.Top = Val(PictureBoxRadioPhone.Top) + 1

End Sub


Private Sub PictureBoxRadioPhone_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)

If Button = vbRightButton Then
    Let MainlineOperationGuiDieselScreen!TextBoxVirtualCabSignalStatusApproaching.Text = "Clear"
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalApproaching(0).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive 9-40CW\SignalLightGreen.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalApproaching(1).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive 9-40CW\SignalLightRed.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalApproaching(2).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive 9-40CW\SignalLightRed.bmp")
    Let MainlineOperationGuiDieselScreen!textboxvirtualCabsignalstatuscurrent.Text = "Clear"
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalCurrent(0).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive 9-40CW\SignalLightGreen.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalCurrent(1).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive 9-40CW\SignalLightRed.bmp")
    Let MainlineOperationGuiDieselScreen!PictureBoxVirtualCabSignalCurrent(2).Picture = LoadPicture(App.Path$ & "\Graphics\Locomotive 9-40CW\SignalLightRed.bmp")
End If

If Button = vbRightButton Then
    If Val(TextBoxStatusRadioPhone.Text) = 0 Then
        Let TextBoxStatusRadioPhone.Text = 1
        Let PictureBoxRadioPhone.Picture = LoadPicture(App.Path + "\Graphics\Locomotive 9-40CW\PhoneOnHook.bmp")
    Else
        Let TextBoxStatusRadioPhone.Text = 0
        Let PictureBoxRadioPhone.Picture = LoadPicture(App.Path + "\Graphics\\Locomotive 9-40CW\PhoneOffHook.bmp")
    End If
End If

End Sub

Private Sub PictureBoxRadioPhone_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Text = "Radio Phone" & Chr$(13) & Chr$(10)
    
        If TextBoxStatusRadioPhone.Text = 0 Then
            Let LabelCaption.Text = LabelCaption.Text + "is In Use"
        ElseIf TextBoxStatusRadioPhone.Text = 1 Then
            Let LabelCaption.Text = LabelCaption.Text & "is not In Use"
        End If
    
        Let LabelCaption.Height = 33.747
        Let LabelCaption.Width = 145.284
        Let LabelCaption.Top = Val(PictureBoxRadioPhone.Top) + Int(Y / 15)
        Let LabelCaption.Left = Val(PictureBoxRadioPhone.Left) + Int(X / 15) + 20
        Let LabelCaption.Visible = True
    End If
End If
...
Let temp = App.Path
Let temp = temp + "\Graphics\Locomotive 9-40CW\ResetLeftOn.bmp"
...
Let temp = App.Path
Let temp = temp + "\Graphics\Locomotive 9-40CW\ResetLeftOff.bmp"
Let PictureBoxResetLeft.Picture = LoadPicture(temp)
...
Let temp = App.Path$
Let temp = temp & "\Graphics\Locomotive 9-40CW\ResetRightOn.bmp"
Let PictureBoxResetRight.Picture = LoadPicture(temp)
...
If MainlineOperationGUI.CheckBoxSoundDecoderEquipped = vbChecked Then
    If Val(TextBoxStatusThrottle.Text) > 0 And Val(TextBoxStatusThrottle.Text) < 8 Then
        If MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "1" Then
            Let MainlineOperationGUI!ConsistControlFunction1.Value = vbChecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionRPMminus.Text = "2" Then
            Let MainlineOperationGUI!ConsistControlFunction2.Value = vbChecked
    ...
    ElseIf Val(TextBoxStatusThrottle.Text) < 0 Then
        If MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "1" Then
            Let MainlineOperationGUI!ConsistControlFunction1.Value = vbChecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "2" Then
            Let MainlineOperationGUI!ConsistControlFunction2.Value = vbChecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "3" Then
            Let MainlineOperationGUI!ConsistControlFunction3.Value = vbChecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "4" Then
            Let MainlineOperationGUI!ConsistControlFunction4.Value = vbnChecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "5" Then
            Let MainlineOperationGUI!ConsistControlFunction5.Value = vbChecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "6" Then
            Let MainlineOperationGUI!ConsistControlFunction6.Value = vbChecked
...
If Val(TextBoxStatusThrottle.Text) < 0 Then
    Let temp = App.Path$ & "\Graphics\Locomotive 9-40CW\DynamicBrake"
Else
    Let temp = App.Path$ & "\Graphics\Locomotive 9-40CW\Throttle"
End If
...
If MainlineOperationGUI.CheckBoxSoundDecoderEquipped = vbChecked Then
    If Val(TextBoxStatusThrottle.Text) = 0 Then
        ...
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "6" Then
            Let MainlineOperationGUI!ConsistControlFunction6.Value = vbUnchecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "7" Then
            Let MainlineOperationGUI!ConsistControlFunction7.Value = vbnChecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "8" Then
            Let MainlineOperationGUI!ConsistControlFunction8.Value = vbUnchecked
        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "9" Then
            Let MainlineOperationGUI!ConsistControlFunction9.Value = vbUnchecked
...
Private Sub PictureBoxResetRight_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Let Temporary$ = App.Path$ & "\Graphics\Locomotive 9-40CW\ResetRightOff.bmp"
    Let PictureBoxResetRight.Picture = LoadPicture(Temporary$)
...
If Val(TextBoxStatusThrottle.Text) = 0 Then
    ...
    If Val(TextBoxStatusSpeedStepModified.Text) = 0 Then
        ...
        Let temp = App.Path$
        Let temp = temp + "\Graphics\Locomotive 9-40CW\/Reverser"
        ...
        ElseIf Val(TextBoxStatusReverser.Text) = 1 Then
            ...
            Let MainlineOperationGUI!ConsistControlDirectionF.Value = vbUnchecked
        ElseIf Val(TextBoxStatusReverser.Text) = 0 Then
            Let MainlineOperationGUI!ConsistControlDirectionR.Value = vbUnchecked
            Let MainlineOperationGUI!ConsistControlDirectionN.Value = vbUnchecked
            Let MainlineOperationGUI!ConsistControlDirectionF.Value = vbChecked
        End If
    Else
        If MainlineOperationGuiDieselScreen.ButtonHelp.Caption = "&Help is On" Then
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Text = "Reverser Handle" & Chr$(13) & Chr$(10)
    
        If TextBoxStatusReverser.Text = 0 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Forward Position"
        ElseIf TextBoxStatusReverser.Text = 1 Then
                Let LabelCaption.Text = LabelCaption.Text & "in Neutral Position"
        ElseIf TextBoxStatusReverser.Text = 2 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Reverse Position"
        End If
...
If TextBoxStatusSand.Text = "Off" Then
    ...
    Let temp = App.Path$
    Let temp = temp + "\Graphics\Locomotive 9-40CW\SandOn.bmp"
    Let PictureBoxSand.Picture = LoadPicture(temp)
    Let MainlineOperationGUI!TimerSandConsumption.Interval = 2500 * Val(MainlineOperationGUI!TextBoxTonnage.Text)
Else
    Let TextBoxStatusSand.Text = "Off"
    Let temp = App.Path$
    Let temp = temp + "\Graphics\Locomotive 9-40CW\SandOff.bmp"
    Let PictureBoxSand.Picture = LoadPicture(temp)
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Text = "Sanding Switch" & Chr$(13) & Chr$(10)
    
        If TextBoxStatusSand.Text = "Off" Then
            Let LabelCaption.Text = LabelCaption & "is Not Active"
        ElseIf TextBoxStatusSand.Text = "On" Then
            Let LabelCaption.Text = LabelCaption.Text & "is Active"
        End If
...
' ===========================================================================================================================================
'
' Throttle/Dynamic Brake Control
'
' This whole routine controls the mouse action of 'click'ing on the throttle picture. The left button generally decreases the throttle and
' the right button generally increases the throttle.
'
' ===========================================================================================================================================
'
' Check Deadmann Switch
'
' If the deadmann switch is active, then resetting is required prior to any control action.
'
...
' Throttle Delay
'
' Has the throttle has been 'click'ed to quickly. General Electic recommends a ten second delay between notches.
'
...
'
        If Button = vbLeftButton Then
            ...
            If TextBoxStatusBell.Text = "Off" And _
               Val(TextBoxStatusThrottle.Text) = 0 And _
               Val(TextBoxStatusReverser.Text) <> 1 And _
...
'
            ...
            If MainlineOperationGUI!OptionVirtualcabSignalYes.Value = True Then
                ...
                ElseIf textboxvirtualCabsignalstatuscurrent.Text = "Restricted" Then
                    If Val(TextBoxStatusThrottle.Text) >= 6 Then
                        Let OkToNotchUp = False
                        If ButtonHelp.Caption = "&Help is On" Then
                ...
                ElseIf textboxvirtualCabsignalstatuscurrent.Text = "Reduced" Then
                    If Val(TextBoxStatusThrottle.Text) >= 3 Then
                        Let OkToNotchUp = False
                        If ButtonHelp.Caption = "&Help is On" Then
            ...
            If OkToNotchUp = True Then
                ...
                If MainlineOperationGUI.CheckBoxSoundDecoderEquipped = vbChecked Then
                    ...
                    If Val(TextBoxStatusThrottle.Text) > 0 And Val(TextBoxStatusThrottle.Text) < 8 Then
                        ...
                        If MainlineOperationGUI!TextBoxMappedFunctionRPMPlus.Text = "1" Then
                            Let MainlineOperationGUI!ConsistControlFunction1.Value = vbChecked
                    ...
                    ElseIf Val(TextBoxStatusThrottle.Text) < 0 Then
                        ...
                        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "9" Then
                            Let MainlineOperationGUI!ConsistControlFunction9.Value = vbUnchecked
                        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "109" Then
                            Let MainlineOperationGUI!ConsistControlFunction10.Value = vbUnchecked
                        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "11" Then
                            Let MainlineOperationGUI!ConsistControlFunction11.Value = vbUnchecked
                        ElseIf MainlineOperationGUI!TextBoxMappedFunctionDynamicBrake.Text = "12" Then
...
'
                    ...
                    If Val(TextBoxStatusThrottle.Text) >= 0 And Val(TextBoxStatusThrottle.Text) < 7 Then
...
' timer to a later time.
        ...
        If TextBoxStatusThrottle.Text <> 0 And TextBoxStatusReverser.Text <> 1 Then
            ...
            Let MainlineOperationGUI!timerdeadmann.Interval = MainlineOperationGuiDieselScreen!TextBoxSettingDeadmannInterval.Text
            Let MainlineOperationGUI!timerdeadmann.Enabled = True
        Else ' If TextBoxStatusThrottle.Text <> 0 And TextBoxStatusReverser.Text <> 1 Then
            Let MainlineOperationGUI!timerdeadmann.Enabled = False
        End If ' If TextBoxStatusThrottle.Text <> 0 And TextBoxStatusReverser.Text <> 1 Then
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Text = "Throttle Handle" & Chr$(13) & Chr$(10)
    
        If TextBoxStatusThrottle.Text = -8 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 8 Position"
        ElseIf TextBoxStatusThrottle.Text = -7 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 7 Position"
        ElseIf TextBoxStatusThrottle.Text = -6 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 8 Position"
        ElseIf TextBoxStatusThrottle.Text = -5 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 5 Position"
        ElseIf TextBoxStatusThrottle.Text = -4 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 4 Position"
        ElseIf TextBoxStatusThrottle.Text = -3 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 3 Position"
        ElseIf TextBoxStatusThrottle.Text = -2 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 2 Position"
        ElseIf TextBoxStatusThrottle.Text = -1 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Dynamic Brake 1 Position"
        ElseIf TextBoxStatusThrottle.Text = 0 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Neutral Position"
        ElseIf TextBoxStatusThrottle.Text = 1 Then
            Let LabelCaption.Text = LabelCaption.Text & "in First Position"
        ElseIf TextBoxStatusThrottle.Text = 2 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Second Position"
        ElseIf TextBoxStatusThrottle.Text = 3 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Third Position"
        ElseIf TextBoxStatusThrottle.Text = 4 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Forth Position"
        ElseIf TextBoxStatusThrottle.Text = 5 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Fifth Position"
        ElseIf TextBoxStatusThrottle.Text = 6 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Sixth Position"
        ElseIf TextBoxStatusThrottle.Text = 7 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Seventh Position"
        ElseIf TextBoxStatusThrottle.Text = 1 Then
            Let LabelCaption.Text = LabelCaption.Text & "in Eighth Position"
        End If
...
Private Sub TetBoxMilageCounterToSignal_Change()

End Sub

Private Sub PictureBoxVirtualCabSignal_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        ...
        Let LabelCaption.Height = 33.747
        Let LabelCaption.Width = 145.284
        Let LabelCaption.Text = "Currently in a " & textboxvirtualCabsignalstatuscurrent.Text & " block and" & Chr$(13) & Chr$(10)
        Let LabelCaption.Text = LabelCaption.Text & Int(TextBoxVirtualCabSignalDistance.Text) & " feet to next " & TextBoxVirtualCabSignalStatusApproaching.Text & " block"
        Let LabelCaption.Top = Val(PictureBoxComputerScreenLeft(1).Top) + Val(PictureBoxVirtualCabSignal.Top / 15) + Int(Y / 15) - 15
        Let LabelCaption.Left = Val(PictureBoxComputerScreenLeft(1).Left) + Val(PictureBoxVirtualCabSignal.Left / 15) + Int(X / 15) + 20 + 15
        Let LabelCaption.Visible = True
    End If
End If
End Sub
...
Private Sub ScrollTimeAdjustment_Change()

Let MainlineOperationGUI!TextBoxTonnage.Text = Val(ScrollTimeAdjustment) / 100 + 1
...
If ButtonCaption.Caption = "&Caption is On" Then
    If MainlineOperationGUI!timerlabel.Enabled = False Then
        Let MainlineOperationGUI!timerlabel.Interval = 1000 * Val(MainlineOperationGUI!TextBoxTonnage.Text)
        Let MainlineOperationGUI!timerlabel.Enabled = True
        Let LabelCaption.Text = "DCC Speed Step" & Chr$(13) & Chr$(10)
        Let LabelCaption.Text = LabelCaption.Text & Str$(TextBoxDigitalSpeed.Text) & " of 128"
        Let LabelCaption.Height = 33.747
        Let LabelCaption.Width = 145.284
...
Private Sub TextBoxStatusDynamicBrakeApplication_Change()
    ...
    Let MainlineOperationGUI!TimerSendCommand.Interval = Val(MainlineOperationGuiDieselScreen!TextBoxSettingsendcommandInterval.Text) * Val(MainlineOperationGUI!TextBoxTonnage.Text) / Val(TextBoxStatusDynamicBrakeApplication.Text / 3 + 1)
    Let MainlineOperationGUI!TimerSendCommand.Enabled = True
    Let MainlineOperationGUI!TimerSpeedChange.Interval = Val(MainlineOperationGuiDieselScreen!TextBoxSettingSpeedChangeInterval.Text) * Val(MainlineOperationGUI!TextBoxTonnage.Text) / Val(TextBoxStatusDynamicBrakeApplication.Text / 3 + 1)
...
' -------------------------------------------------------------------------------------------------------------------------------------------
' Update TextBox
' For Dynamic Brake Value
'

If Val(TextBoxStatusThrottle.Text) < 1 Then
    Let TextBoxStatusDynamicBrakeApplication.Text = Abs(Val(TextBoxStatusThrottle.Text))
End If
...
Private Sub textboxvirtualsignaldistance_Change()
