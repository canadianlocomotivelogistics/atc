...
Begin VB.Form MainlineOperationGuiDiesel2Screen 
   ...
   Height          =   11940
   Icon            =   "MainlineOperationGuiDiesel3creen.frx":0000
   Left            =   1185
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   914.292
   ...
   Begin VB.PictureBox PictureSpeedometer 
      ...
      Height          =   1395
      Left            =   11700
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":0442
      ScaleHeight     =   93
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   94
      TabIndex        =   27
   ...
   Begin TransPicture.TransPictureCtl TransPictureHeadlight 
      ...
      _ExtentX        =   1376
      _ExtentY        =   1032
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":6BB0
   End
   Begin TransPicture.TransPictureCtl TransPictureThrottle 
      ...
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":83C6
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBrakeDynamic 
      ...
      _ExtentY        =   1852
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":1AAC8
   End
   Begin TransPicture.TransPictureCtl TransPictureReverser 
      ...
      _ExtentX        =   2990
      _ExtentY        =   1058
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":27342
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureSand 
      ...
      _ExtentX        =   1984
      _ExtentY        =   1085
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":2A8B4
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBell 
      ...
      _ExtentX        =   1138
      _ExtentY        =   1191
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":2CD8A
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBrakeIndependent 
      ...
      _ExtentX        =   6509
      _ExtentY        =   1826
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":2E510
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureBrakeAutomatic 
      ...
      _ExtentY        =   1244
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":3ACD6
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureHorn 
      ...
      _ExtentY        =   5027
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":42E68
   End
   ...
   Begin TransPicture.TransPictureCtl TransPictureCab 
      ...
      _ExtentY        =   20320
      TransparentColor=   16777215
      Picture         =   "MainlineOperationGuiDiesel3creen.frx":48DBA
   End
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    If InternetSettings.optionHost = True Then
        ...
        Let VideoCapture.UseVMR9 = False
...
Private Sub Form_Activate()
    ...
    If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
        Let DebugMode!TextBoxDebugMode.Text = DebugMode!TextBoxDebugMode.Text & vbCrLf & "Beginning Mainline Operation GUI Diesel2 Screen, Form, Activate"
    End If
...
' =============================================================================================================================================================================
    If InternetSettings.optionHost = True Then
        If InternetSettings.NetConnect.Connected = True Then
            Call VideoModule.VideoOn(Screen.ActiveForm)
            ' -----------------------------------------------------------------------------------------------------------------------------------------------------------------
            ' Start Broadcasting
            ' -----------------------------------------------------------------------------------------------------------------------------------------------------------------
            VideoCapture.StartBroadcast 10103, 2
        End If
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
' Client Mode
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ElseIf InternetSettings.optionclient = True Then
        If InternetSettings.NetConnect.Connected = True Then
            If InternetSettings.checkboxclientstreamtypebroadcast.Value = vbChecked Then
                VideoCapture.PlayerOpen "http://atc.server" & CStr(Val(InternetSettings!ComboServerName.ListIndex)) & ".lovethosetrains.com:10103"
                DoEvents
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    If MainScreen!menuDebugMode.Caption = "&Debug Mode is On" Then
        Let DebugMode!TextBoxDebugMode.Text = DebugMode!TextBoxDebugMode.Text & vbCrLf & "Ending Mainline Operation GUI Diesel2 Screen, Form, Activate"
    End If
...
' -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Let TempSpeed = Int(TempThrottle - TempBrakeAutomatic - TempIndependent - TempBrakeDynamic)
...
'Let LabelLocomotiveNumberDisplay.Caption = Val(MainlineOperationGUI!ConsistControlMacroLocomotiveNumber.Text)
